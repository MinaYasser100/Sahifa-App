...
import 'package:sahifa/features/profile/ui/widgets/profile_widgets/tablet_profile_data_widget.dart';

class TabletUserProfileSection extends StatelessWidget {
  const TabletUserProfileSection({super.key, required this.isDark});
    ...
    return BlocBuilder<ProfileUserCubit, ProfileUserState>(
      builder: (context, state) {
        ...
        if (state is ProfileUserSuccess) {
          return TabletProfileDataWidget(
            isDark: isDark,
