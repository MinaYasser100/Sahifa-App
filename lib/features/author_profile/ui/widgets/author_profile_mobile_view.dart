...
import 'package:sahifa/features/author_profile/ui/widgets/author_articles_list.dart';
...
class AuthorProfileMobileView extends StatelessWidget {
  const AuthorProfileMobileView({
    super.key,
